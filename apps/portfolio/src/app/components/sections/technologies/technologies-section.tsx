...
export function TechnologiesSection() {
  return (
    <Section className="flex flex-col items-center justify-center" id="technologies">
      <div className="w-full flex items-start justify-start">
        <h1 className="font-grand-slang text-[80px] md:text-[200px] pb-0 md:pb-5">Tech</h1>
      </div>
      <section className="h-[calc(100vh-64px)] w-full">
        <div className="w-full grid grid-cols-1 gap-x-5 lg:grid-cols-3">
          <div className="col-span-1 lg:col-span-2">
            <h2 className="text-5xl pb-5 font-grand-slang">Find a good quote here</h2>
            <br />
            <p
              style={{ lineHeight: '1.9rem', letterSpacing: '.5px', opacity: 0.85 }}
              className="font-montserrat font-normal tracking-[0.5px] max-w-4/5"
            >
